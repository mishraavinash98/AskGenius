...
<div class="row">
      ...
      <h3 class="welcome">Welcome <span style="color:#2484A4;"> <?php echo $_SESSION['username'];?></span></h3>
        <?php $username=$_SESSION['username'];   ?>
            ...
            <form class="form-horizontal" role="form" action="papersoln.php" method="POST">          
              <div class="col-md-7">
              ...
              <h3>All Available PaperSolutions for <?php echo $_POST['dept'];?> and  <?php echo $_POST['sem'];?></h3>
            ...
            <table cellpadding="2" cellspacing="2" border="2" class="table table-bordered">
              ...
              <?php
			   ...
			   $data = mysqli_query($link,"SELECT * from papersoln WHERE dept ='$dept' and sem='$sem'; ");
